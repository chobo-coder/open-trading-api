...
config_root = os.path.join(os.path.dirname(os.path.dirname(__file__)),'user')
...
token_tmp = os.path.join(config_root , 'KIS' + datetime.today().strftime("%Y%m%d"))  # 토큰 로컬저장시 파일명 년월일
